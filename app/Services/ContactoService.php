 ...
 * TAREA 1
 * 
 * ContactoService - Servicio de gestión de contactos
 * 
 * Capa de lógica de negocio que actúa como intermediario
 * entre los controladores y el modelo de datos.
 * 
 * FIN TAREA
*/
...
class ContactoService
{
    ...
    */
        try {
            ...
            $contacto = $this->contactoModel->get($id);
            if (!$contacto) {
                return false;
            }
            ...
            $this->contactoModel->setNombre($datos['nombre']);
            $this->contactoModel->setTelefono($datos['telefono']);
            $this->contactoModel->setEmail($datos['email']);
